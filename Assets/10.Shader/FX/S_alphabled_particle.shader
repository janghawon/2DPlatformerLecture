...
Shader "1_fx/alphablended"
{
	Properties
	{
		...
		_Main_Pow("Main_Pow", Range( 0 , 10)) = 1.952941
		...
		[Toggle(_USE_PIXELIZE_ON)] _use_pixelize("use_pixelize", Float) = 0
		[ASEEnd][IntRange]_Pixelize("Pixelize", Range( 1 , 128)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _USE_PIXELIZE_ON
				 ...
				 ) : SV_Target
			{
				...
				#ifdef _USE_PIXELIZE_ON
				float2 staticSwitch42 = ( ceil( ( uv_Main_Texture * _Pixelize ) ) / _Pixelize );
				#else
				float2 staticSwitch42 = uv_Main_Texture;
				#endif
				float4 tex2DNode1 = tex2D( _Main_Texture, staticSwitch42 );
...
Node;AmplifyShaderEditor.SamplerNode;1;-413,-420.5;Inherit;True;Property;_Main_Texture;Main_Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;4edca27ce27b0db448831594f5302f83;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-1474.004,-409.0202;Inherit;False;0;1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CeilOpNode;43;-1106.685,-300.3484;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-1232.823,-296.1084;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;45;-977.3675,-306.7082;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-1435.279,-171.0309;Inherit;False;Property;_Pixelize;Pixelize;11;1;[IntRange];Create;True;0;0;0;False;0;False;1;1;1;128;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;42;-834.2704,-399.9865;Inherit;True;Property;_use_pixelize;use_pixelize;10;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-566,-181.5;Inherit;False;Property;_Main_Pow;Main_Pow;1;0;Create;True;0;0;0;False;0;False;1.952941;1.952941;0;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=23F549DA04C05DEB74FBA62CC38435741AC84A56